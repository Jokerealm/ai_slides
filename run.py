#!/usr/bin/env python3
"""
ai_slides Application Runner

This script starts the ai_slides FastAPI application with proper configuration.
"""
...
def main():
    ...
    print("🚀 Starting ai_slides Server...")
